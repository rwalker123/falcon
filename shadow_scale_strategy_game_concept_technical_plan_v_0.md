...
- You begin as the lead of a Late Forager Tribe: a **single small band** (~30 people) that is your entire **labor pool**. Rather than commanding separate Scout/Hunter/Guardian *bands*, you partition the band's working-age population across equipment-gated **roles** — Foraging, Hunting, Scouting, Warrior (Crafting arrives with the tool-making economy). The band splits into more bands as it grows. The world is shrouded by Fog of Discovery: tiles are unknown until observed; resources and chemistry hints appear only after local surveys and experiments. See `docs/plan_early_game_labor.md` for the labor-pool / equipment model that drives the opening.
