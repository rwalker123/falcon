...
- **You never stop working it.** Intensifying does not hand you free food — it makes **each worker feed more people**. That is how you buy freedom: the same band feeds itself with fewer hands, and the rest go do something else. A Field is not a gift; it is a job that pays better than foraging.
- **Climbing raises four things:** yield **per worker**, how fast the source **regrows**, how much it can **hold**, and — for animals — how **close** it stays. A wild herd roams far and you chase it; a tamed herd drifts along with your band; a penned herd stands at your fence. Far → near → fixed.
