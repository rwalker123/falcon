...
Every food source — plant or animal — climbs the **same three rungs**, driven by the same grammar. This is the bridge from "we eat what we find" to "we make our food," and it is where most of your early labor decisions live. See `docs/plan_intensification_ladder.md` for the model.

- **Two paths, one grammar.** *Plants:* a wild forage patch → **Cultivate** it into a **Tended Patch** → **Sow** a **Field**. *Animals:* a wild herd → **Tame** it into a **Pastoral** herd → **Corral** it into a **Pen**. Same shape both sides: a verb you choose deliberately, not a thing that happens to you.
