...
- Predators & the Danger of the Hunt (designed — see `docs/plan_predators.md`): not every animal is meat you simply take. A predator is an animal like any other — it just **eats other animals** instead of grass, so it goes where the game is, **follows** the herds, competes with you for the very deer you were counting on, and **fades when the game is gone** (no one has to cull the wolves — hunger does; their numbers rise with the herds and crash with them). And the hunt itself can **cost you people**. Every beast carries a **defense** — a deer only runs, but a mammoth gores and an aurochs charges, so the biggest game is a **windfall you can be killed collecting** — and a predator carries **teeth** on top of it: it will raid your unguarded foragers unprovoked. So *which* beast a hunter can take is honest — a lone forager cannot bring down a mammoth any more than a wolf can. You can turn on the predators and **wipe them out** (the *Eradicate* you already know), but that is a fight, and a fight is **a fight like any other in this world** — resolved by who you send and what they carry. **Warriors** are the answer: a role that produces no food but guards the hunt and the camp, bare hands giving way to spears and weapons as your tool-making grows. Send hunters after a mammoth with no guard and you will bury some of them; send Warriors and the same hunt comes home whole. *(The wolf that shadows your hunts may, in far time, come to heel and hunt at your side — but that is a later and stranger story.)*
