...
**Appended LAST in `CHAPTERS`**, so no existing frame moves. Four frames and 82 assertions (its
`EXPECTED_CHECKPOINTS` floor is the measured 86 — frames count too), and **most
