...
pub struct WorldSnapshot {
    ...
    /// **The ranging party's default** — what `send_expedition` / `send_trade_expedition` launch
    /// with when the player names no kit. Its own default beside the four above because a
    /// provisioned party feeds itself by gathering *and* by hunting, and one kit arms both.
    #[serde(default)]
    pub default_expedition_kit_id: String,
...
pub struct WorldDelta {
    ...
    #[serde(default)]
    pub default_expedition_kit_id: Option<String>,
