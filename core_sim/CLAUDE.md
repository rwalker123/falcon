...
| `equipment.md` | The minimal TOE — the hunting & carry kits, the two-tier rule, the durability cliff | `equipment_config.rs`, `creatures_config.rs`, `data/equipment.json` |
