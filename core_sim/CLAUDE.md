...
| `work-party.md` | The work party — hunt and forage are one model: a far row posts a party instead of lapsing, distance is paid in porters and friction past the road-widened free reach, the take flows HOME always, and a posting the band cannot supply walks home | `work_party.rs`, `systems/labor.rs`, `supply.rs`, `labor_config.rs`, `tests/labor_allocation.rs` |
