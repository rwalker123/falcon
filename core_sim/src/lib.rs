...
pub use fauna::{
    ...
    hunt_take_bound, hunt_take_overdraws, hunt_take_workers, hunt_useful_crew, pen_upkeep,
    per_hunter_take_biomass, project_arrivals_hunt, project_realized_hunt, quantise_animal_take,
    quarry_default_hunt_kit, regrowth_delta_at, repopulate_fauna, resolve_hunt_engagement,
