...
pub use fauna::{
    ...
    forecast_expected_take, forecast_take_range, herd_at_risk_is_built, herd_capacity,
    herd_default_hunt_kit, herd_ecology, herd_herded_fraction, herd_herders_needed,
    herd_hunt_yield, herd_keeper_load, herd_keeper_loads, herd_past_recovery, herd_quarry_fight,
