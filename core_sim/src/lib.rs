...
pub use fauna::{
    ...
    herd_capacity, herd_carry_rate, herd_default_hunt_kit, herd_density_gain,
    ...
    herd_meter_rot, herd_past_recovery, herd_quarry_fight, herd_rung_already_built,
    herd_space_capacity, herd_take_room, herd_upkeep_demand, herd_upkeep_shortfall,
    herd_upkeep_supply, herd_upkeep_workers_needed, herd_wariness, hunt_crew_take_curve,
    ...
    species_requires_denial, stay_fraction, sustainable_yield, unqueue_build_and_cancel_ring,
