...
pub use fauna::{
    ...
    herd_build_verb, herd_capacity, herd_default_hunt_kit, herd_ecology, herd_engage_rate,
    ...
    herd_rung_already_built, herd_take_room, herd_upkeep_demand, herd_upkeep_shortfall,
    herd_upkeep_supply, herd_upkeep_workers_needed, hunt_crew_take_curve, hunt_engage_workers,
    hunt_escapement_ceiling, hunt_haul_workers, hunt_source_yield_preview, hunt_take_bound,
    hunt_take_overdraws, hunt_take_workers, hunt_useful_crew, pen_upkeep, per_hunter_take_biomass,
