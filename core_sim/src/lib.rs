...
pub use fauna::{
    ...
    herd_upkeep_demand, herd_upkeep_shortfall, herd_upkeep_supply, hunt_engage_workers,
    hunt_escapement_ceiling, hunt_haul_workers, hunt_source_yield_preview, hunt_take_bound,
    hunt_take_overdraws, hunt_take_workers, pen_upkeep, per_hunter_take_biomass,
    project_arrivals_hunt, project_realized_hunt, quantise_animal_take, quarry_default_hunt_kit,
    regrowth_delta_at, repopulate_fauna, resolve_hunt_fight, retreat_seed, spawn_initial_herds,
