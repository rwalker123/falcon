...
pub use components::{
    ...
    ResidentBand, Settlement, SourceYield, StartingUnit, TakeSelection, Tile, TownCenter,
...
pub use fauna::{
    ...
    herd_build_verb, herd_capacity, herd_default_hunt_kit, herd_density_gain,
    herd_destination_capacity, herd_ecology, herd_engage_rate, herd_herded_fraction,
    herd_herders_needed, herd_hunt_yield, herd_keeper_load, herd_keeper_loads, herd_keeping_basis,
    herd_meter_rot, herd_past_recovery, herd_quarry_fight, herd_rung_already_built, herd_take_room,
    ...
    hunt_useful_crew, pen_upkeep, per_hunter_take_biomass, project_arrivals_hunt,
...
pub use forage::{
    ...
    patch_destination_capacity, patch_keeping_basis, patch_material_yields, patch_meter_rot,
    patch_provisions_per_biomass, patch_rung_already_built, patch_rung_work_done,
    patch_species_quality, patch_tender_loads, patch_unwinding_key, patch_upkeep_demand,
    patch_upkeep_shortfall, patch_upkeep_workers_needed, plant_rung_span, project_arrivals_forage,
    project_realized_forage, resolve_committed_species, resolve_take_selection,
    rung_material_yields, rung_payoff, rung_site_refusal, selected_biomass_share,
    ...
    SpeciesRate, SpeciesRefusal, CANNOT_CLIMB_RATIO, CULTIVATION_DISCOVERY_ID, NO_FORAGE_SEASON,
    NO_TENDER_LOAD, ONE_TENDER_LOAD, SEED_SELECTION_DISCOVERY_ID, WHOLE_BASKET,
};
...
pub use intensification::{
    ...
    SITE_ACCEPTED, WHOLLY_UNSUPPLIED,
};
