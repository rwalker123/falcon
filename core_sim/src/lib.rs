...
pub use fauna::{
    ...
    herd_ecology, herd_herded_fraction, herd_herders_needed, herd_hunt_yield, herd_is_maintaining,
    herd_keeper_load, herd_keeper_loads, herd_past_recovery, herd_quarry_fight, herd_upkeep_demand,
...
pub use forage::{
    ...
    patch_is_maintaining, patch_material_yields, patch_provisions_per_biomass,
...
pub use intensification::{
    activity_work, build_fraction, build_turns_remaining, build_work_per_worker_turn,
    distribute_upkeep_pool, knows, learn_multiplier, load_intensification_ladder_from_env,
    upkeep_shortfall, upkeep_shortfall_fraction, LadderConfig, LadderConfigHandle,
