...
- Update `docs/architecture.md` and `shadow_scale_strategy_game_concept_technical_plan_v_0.md` whenever gameplay intent or engineering plans shift; backlog items live in **GitHub Issues** (the Falcon Backlog project).
