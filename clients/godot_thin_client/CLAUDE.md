...
- **The selection card — ONE card, ONE list, ONE drawer** (`Hud.gd`,
  ...
  **detail** for **herds/expeditions** (`_herd_summary_lines` +
  ...
  VISIBLE furniture and would read as a rendering fault. Selecting a row (`_on_roster_row_selected`) re-homes the
