...
- Replaces the bespoke `ui/AutoSizingPanel.gd` height math — the dock's own
  ...
  the dock via the shared `ui/hud/DockScrollFit.gd`; the Telling panel is a
  fixed-size book (`PAGE_HEIGHT`) and needs neither.
