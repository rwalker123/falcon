...
| `command-transport.md` | One seated command connection: the seat claim, which verbs stay off it, reconnect, and End Turn as a submission | `CommandClient.gd`, `SeatClaim.gd`, `bridge/command_link.rs`, `Main.gd` |
