...
# THE SAME ROW WITH THE STOCK UNKNOWN — `— / 205`, what BOTH webs read on a remembered tile (issue
# #462). The capacity is still the tile's own and still true; only the standing level is unknowable
